<?php $user = \App\Models\Auth::user();
    $cartContents = \App\Models\Cart::retrieve();
?>
<!DOCTYPE html>
<!--
...
<body class="hold-transition skin-black <?= \App\Models\Auth::user()->isAdmin() ? 'sidebar-mini' : 'layout-top-nav' ;?>">
    <div class="wrapper">
...
<header class="main-header">
  ...
  <nav class="navbar navbar-static-top" role="navigation">
      ...
      <?php if (!$user->isAdmin()) {
          include realpath(__DIR__ . '/../partials/nav.view.php');
      }?>
      <!-- Navbar Right Menu -->
      <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="label label-success" id="cartCount"><?=(new \App\Models\Cart)->count()?></span>
            </a>
              ...
              <li>
                ...
                <?php foreach($cartContents as $key => $item) { ?>
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?= assetload($item->image) ?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        <?= $item->name ?>
                        <small><i class="fa fa-fa-money"></i> <strong>Q <?= $item->quantity ?></strong></small>
                      </h4>
                      <p><i class="fa fa-fa-money"></i>₦ <?= ($item->price * $item->quantity) ?></p>
                    </a>
                  </li>
              <?php } ?>
                </ul>
